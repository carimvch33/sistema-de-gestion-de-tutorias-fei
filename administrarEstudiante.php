...
<body>
    ...
    <div class="new-button-container">
        <button class="buttonNew" onclick="location.href = './registroEstudiante.php' "><i class="fas fa-plus"></i> Nuevo</button>
    </div>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<tr>
                                    ...
                                    <td class='action-buttons autoTable'>
                                        ...
                                        <button class='delete' data-id-tutorado='{$idTutorado}' data-csrf-token='{$_SESSION['csrf_token']}'><i class='fas fa-trash-alt'></i></button>
                                    </td>
                                </tr>";
                        }
                    }
    ...
    $(document).ready(function() {
        ...
        $('#searchEstudiante').on('input', function() {
            ...
            $('table tr').each(function(index) {
                if (index !== 0) { 
                    var tutoradoNombre = $(this).find('td:first').text().toLowerCase();
                    if (tutoradoNombre.includes(searchValue)) {
                        $(this).show();
                    } else {
                        $(this).hide();
                    }
