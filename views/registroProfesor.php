...
<head>
    <meta charset="UTF-8">
    <title>Formulario de Registro de Profesores</title>
    <link rel="stylesheet" href="<?= BASE_URL; ?>/assets/css/registroProfesor.css">
...
<body>
    ...
    <div class="header-container">
        ...
        <div class="header-left">
            <button class="buttonsHead" onclick="location.href='<?= BASE_URL; ?>/administrarProfesores.php'"><i class="fas fa-arrow-left"></i> Regresar</button>
    ...
    <div class="container mt-5">
        ...
        <form action="<?= BASE_URL; ?>/crearProfesor.php" method="post" enctype="multipart/form-data" id="form">

            <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrf_token) ?>">
            <input type="hidden" name="rol" value="<?= htmlspecialchars($rol) ?>">

            <div class="form-group">
                <label for="nombre">Nombre de profesor: <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre de profesor máximo 70 caracteres" maxlength="70">
            </div>
            ...
            <div class="form-group">
                ...
                <p class="text-secondary">Ejem: zs12345678@uv.mx | zs12345678@estudiantes.uv.mx</p>
            </div>

            <div class="form-group row">
                <div class="col-md-auto">
                    <button type="submit" class="btn btn-success buttonGreen" id="enviar">Guardar Profesor</button>
                </div>
            </div>
        </form>
    </div>
    ...
    <script src="<?= BASE_URL; ?>/assets/js/registroProfesor.js"></script>
</body>
