...
<head>
    ...
    <link rel="stylesheet" href="assets/css/registroProfesor.css">
...
<body>
    ...
    <div class="header-container">
        ...
        <div class="header-left">
            <button class="buttonsHead" onclick="location.href='./administrarProfesores.php'"><i class="fas fa-arrow-left"></i> Regresar</button>
    ...
    <script src="assets/js/registroProfesor.js"></script>
</body>
