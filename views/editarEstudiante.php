...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL; ?>/assets/css/editarEstudiante.css">
...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="<?= BASE_URL; ?>/actualizarEstudiante.php" method="post" enctype="multipart/form-data" id="form">
    ...
    <script src="<?= BASE_URL; ?>/assets/js/editarEstudiante.js"></script>
</body>
