...
<head>
    ...
    <link rel="stylesheet" href="assets/css/editarEstudiante.css">
...
<body>
    <div class="header-container">
        ...
        <div class="header-left">
            <button class="buttonsHead" onclick="location.href='./administrarEstudiantes.php'"><i
    ...
    <div class="container mt-5">
        ...
        <form action="/actualizarEstudiante.php" method="post" enctype="multipart/form-data" id="form">
            <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrf_token) ?>">
            <input type="hidden" name="idTutorado" value="<?= htmlspecialchars($estudiante['idTutorado']) ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="paterno" name="paterno"
                    ...
                    value="<?= htmlspecialchars($estudiante['apellidoPaterno']) ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="materno" name="materno"
                    ...
                    value="<?= htmlspecialchars($estudiante['apellidoMaterno']) ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="matricula" name="matricula"
                    ...
                    value="<?= htmlspecialchars($estudiante['matricula']) ?>">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="carrera" name="carrera">
                    ...
                    <?php foreach ($carreras as $carreraOption) {
                        $selected = ($estudiante['carrera'] == $carreraOption['idCarrera']) ? 'selected' : '';
                        ?>
                        <option value="<?= $carreraOption['idCarrera']; ?>" <?= $selected; ?>>
                            <?= htmlspecialchars($carreraOption['carrera']); ?>
                        </option>
                    <?php } ?>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="correoInstitucional" name="correoInstitucional"
                    ...
                    value="<?= htmlspecialchars($estudiante['correoInstitucional']) ?>">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="tutor" name="tutor">
                    <option value="" disabled>-----Selecciona un tutor asignado al estudiante-----</option>
                    <?php foreach ($tutores as $tutorOption) {
                        $selected = ($estudiante['tutor'] == $tutorOption['idTutor']) ? 'selected' : '';
                        ?>
                        <option value="<?= $tutorOption['idTutor']; ?>" <?= $selected; ?>>
                            <?= htmlspecialchars($tutorOption['profesorNombre']); ?>
                        </option>
                    <?php } ?>
                </select>
            </div>
    ...
    <script src="assets/js/editarEstudiante.js"></script>
</body>
