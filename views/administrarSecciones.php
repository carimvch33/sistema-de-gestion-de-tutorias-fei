...
<head>
    ...
    <link rel="stylesheet" href="assets/css/administrarSecciones.css">
...
<body>
    ...
    <div class="new-button-container">
        <button class="buttonNew" onclick="location.href = './registroSeccion.php' "><i class="fas fa-plus"></i>
            Nuevo</button>
    </div>
    ...
    <script src="assets/js/administrarSecciones.js"></script>
</body>
