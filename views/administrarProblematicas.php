...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL; ?>/assets/css/administrarProblematicas.css">
...
<body>
    ...
    <div class="new-button-container">
        <button class="buttonNew" onclick="location.href = '<?= BASE_URL; ?>/registroProblematica.php' "><i class="fas fa-plus"></i> Nuevo</button>
    </div>
    ...
    <script src="<?= BASE_URL; ?>/assets/js/administrarProblematicas.js"></script>
</body>
