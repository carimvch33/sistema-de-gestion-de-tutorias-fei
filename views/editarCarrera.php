...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL; ?>/assets/css/editarCarrera.css">
...
<body>
    <div class="header-container">
        ...
        <div class="header-left">
            <button class="buttonsHead" onclick="location.href='<?= BASE_URL; ?>/administrarCarreras.php'"><i
    ...
    <div class="container mt-5">
        ...
        <form action="<?= BASE_URL; ?>/actualizarCarrera.php" method="POST" enctype="multipart/form-data" id="form">
    ...
    <script src="<?= BASE_URL; ?>/assets/js/editarCarrera.js"></script>
</body>
