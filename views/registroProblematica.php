...
<head>
    ...
    <link rel="stylesheet" href="assets/css/registroProblematica.css">
...
<body>
    ...
    <div class="header-container">
        ...
        <div class="header-left">
            <button class="buttonsHead" onclick="location.href='./administrarProblematicas.php'"><i class="fas fa-arrow-left"></i> Regresar</button>
    ...
    <script src="assets/js/registroProblematica.js"></script>
</body>
