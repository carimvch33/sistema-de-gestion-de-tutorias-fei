...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL; ?>/assets/css/registroSeccion.css">
...
<body>
    ...
    <div class="header-container">
        ...
        <div class="header-left">
            <button class="buttonsHead" onclick="location.href='<?= BASE_URL; ?>/administrarSecciones.php'"><i
    ...
    <div class="container mt-5">
        ...
        <form action="<?= BASE_URL; ?>/crearSeccion.php" method="post" enctype="multipart/form-data" id="form">
    ...
    <script src="<?= BASE_URL; ?>/assets/js/registroSeccion.js"></script>
</body>
