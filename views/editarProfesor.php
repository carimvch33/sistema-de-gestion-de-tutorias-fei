...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="<?= BASE_URL; ?>/actualizarProfesor.php" method="POST" enctype="multipart/form-data" id="form">

            <input type="hidden" name="idTutor" value="<?php echo htmlspecialchars($profesor['idTutor']); ?>">
            <input type="hidden" name="rol" value="<?php echo htmlspecialchars($profesor['rol']); ?>">
            <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrf_token); ?>">

            <div class="form-group">
                <label for="nombre">Nombre de <?php echo $academico; ?>: <span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="nombre" name="nombre"
                    placeholder="Nombre de profesor máximo 70 caracteres" maxlength="70"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="paterno" name="paterno"
                    ...
                    value="<?php echo htmlspecialchars($profesor['apellidoPaterno']); ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="materno" name="materno"
                    ...
                    value="<?php echo htmlspecialchars($profesor['apellidoMaterno']); ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="noPersonal" name="noPersonal"
                    ...
                    value="<?php echo htmlspecialchars($profesor['noPersonal']); ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="correoInstitucional" name="correoInstitucional"
                    ...
                    value="<?php echo htmlspecialchars($profesor['correoInstitucional']); ?>">
    ...
    <script src="<?= BASE_URL; ?>/assets/js/editarProfesor.js"></script>
</body>
