...
<head>
    ...
    <link rel="stylesheet" href="assets/css/editarSeccion.css">
...
<body>
    <div class="header-container">
        ...
        <div class="header-left">
            <button class="buttonsHead" onclick="location.href='./administrarSecciones.php'"><i class="fas fa-arrow-left"></i> Regresar</button>
    ...
    <div class="container mt-5">
        ...
        <form action="/modificarSeccion.php" method="POST" enctype="multipart/form-data" id="form">
    ...
    <script src="assets/js/editarSeccion.js"></script>
</body>
