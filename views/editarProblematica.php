...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL; ?>/assets/css/editarProblematica.css">
...
<body>
    <div class="header-container">
        ...
        <div class="header-left">
            <button class="buttonsHead" onclick="location.href='<?= BASE_URL; ?>/administrarProblematicas.php'"><i
    ...
    <div class="container mt-5">
        ...
        <form action="<?= BASE_URL; ?>/actualizarProblematica.php" method="POST" enctype="multipart/form-data" id="form">
    ...
    <script src="<?= BASE_URL; ?>/assets/js/editarProblematica.js"></script>
</body>
