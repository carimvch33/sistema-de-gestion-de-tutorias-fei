...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL; ?>/assets/css/registroCarrera.css">
...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="<?= BASE_URL; ?>/crearCarrera.php" method="post" enctype="multipart/form-data" id="form">
    ...
    <script src="<?= BASE_URL; ?>/assets/js/registroCarrera.js"></script>
</body>
