...
<head>
    ...
    <link rel="stylesheet" href="assets/css/registroTipoProblematica.css">
...
<body>
    ...
    <div class="header-container">
        ...
        <div class="header-left">
            <button class="buttonsHead" onclick="location.href='./administrarTiposProblematicas.php'"><i class="fas fa-arrow-left"></i> Regresar</button>
    ...
    <div class="container mt-5">
        ...
        <form action="/crearTipoProblematica.php" method="post" enctype="multipart/form-data" id="form">
    ...
    <script src="assets/js/registroTipoProblematica.js"></script>
</body>
