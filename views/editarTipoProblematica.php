...
<head>
    ...
    <link rel="stylesheet" href="assets/css/editarTipoProblematica.css">
...
<body>
    <div class="header-container">
        ...
        <div class="header-left">
            <button class="buttonsHead" onclick="location.href='./administrarTiposProblematicas.php'"><i
    ...
    <div class="container mt-5">
        ...
        <form action="/actualizarTipoProblematica.php" method="POST" enctype="multipart/form-data" id="form">
    ...
    <script src="assets/js/editarTipoProblematica.js"></script>
</body>
