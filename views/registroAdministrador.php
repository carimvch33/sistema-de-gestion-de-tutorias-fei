...
<head>
    ...
    <link rel="stylesheet" href="assets/css/registroAdministrador.css">
...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="/crearAdministrador.php" method="post" enctype="multipart/form-data" id="form">
    ...
    <script src="assets/js/registroAdministrador.js"></script>
</body>
