...
<head>
    ...
    <link rel="stylesheet" href="assets/css/editarAdministrador.css">
...
<body>
    <div class="header-container">
        ...
        <div class="header-left">
            <button class="buttonsHead" onclick="location.href='./administrarAdministradores.php'"><i
    ...
    <div class="container mt-5">
        ...
        <form action="/actualizarAdministrador.php" method="POST" enctype="multipart/form-data" id="form">

            <input type="hidden" name="idAdministrador"
                value="<?php echo htmlspecialchars($administrador['idAdministrador']); ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="paterno" name="paterno"
                    ...
                    value="<?php echo htmlspecialchars($administrador['apellidoPaterno']); ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="materno" name="materno"
                    ...
                    value="<?php echo htmlspecialchars($administrador['apellidoMaterno']); ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="correoInstitucional" name="correoInstitucional"
                    ...
                    value="<?php echo htmlspecialchars($administrador['correoInstitucional']); ?>">
            </div>

            <div class="form-group">
                <label for="password">Contraseña:</label>
                <input type="password" class="form-control" id="password" name="password"
                    placeholder="Ingrese una nueva contraseña si desea cambiarla" maxlength="255">
                <small class="form-text text-muted">Deje este campo en blanco si no desea cambiar la contraseña.</small>
            </div>

            <div class="form-group">
                <label for="confirm_password">Confirmar Contraseña:</label>
                <input type="password" class="form-control" id="confirm_password" name="confirm_password"
                    placeholder="Confirme la nueva contraseña" maxlength="255">
            </div>
