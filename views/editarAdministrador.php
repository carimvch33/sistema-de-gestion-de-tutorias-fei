...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL; ?>/assets/css/editarAdministrador.css">
...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="<?= BASE_URL; ?>/actualizarAdministrador.php" method="POST" enctype="multipart/form-data" id="form">
    ...
    <script src="<?= BASE_URL; ?>/assets/js/editarAdministrador.js"></script>
</body>
