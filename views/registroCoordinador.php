...
<head>
    <meta charset="UTF-8">
    <title>Formulario de Registro de Coordinadores</title>
    <link rel="stylesheet" href="<?= BASE_URL; ?>/assets/css/registroCoordinador.css">
...
<body>
    ...
    <div class="header-container">
        ...
        <div class="header-left">
            <button class="buttonsHead" onclick="location.href='<?= BASE_URL; ?>/administrarCoordinadores.php'"><i
    ...
    <div class="container mt-5">
        ...
        <form action="<?= BASE_URL; ?>/crearCoordinador.php" method="post" enctype="multipart/form-data" id="form">

            <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrf_token) ?>">
            <input type="hidden" name="rol" value="<?= htmlspecialchars($rol) ?>">

            <div class="form-group">
                <label for="nombre">Nombre de coordinador: <span class="text-danger">*</span></label>
            ...
            <div class="form-group row">
                <div class="col-md-auto">
                    <button type="submit" class="btn btn-success buttonGreen" id="enviar">Guardar Coordinador</button>
                </div>
            </div>
        </form>
    </div>
    ...
    <script src="<?= BASE_URL; ?>/assets/js/registroCoordinador.js"></script>
</body>
