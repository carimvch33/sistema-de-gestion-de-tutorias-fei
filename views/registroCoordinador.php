...
<head>
    ...
    <link rel="stylesheet" href="assets/css/registroCoordinador.css">
...
<body>
    ...
    <div class="header-container">
        ...
        <div class="header-left">
            <button class="buttonsHead" onclick="location.href='./administrarCoordinadores.php'"><i
    ...
    <div class="container mt-5">
        ...
        <form action="/crearCoordinador.php" method="post" enctype="multipart/form-data" id="form">
    ...
    <script src="assets/js/registroCoordinador.js"></script>
</body>
