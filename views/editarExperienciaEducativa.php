...
<head>
    ...
    <link rel="stylesheet" href="assets/css/editarExperienciaEducativa.css">
...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="/actualizarExperiencia.php" method="POST" enctype="multipart/form-data" id="form">
    ...
    <script src="assets/js/editarExperienciaEducativa.js"></script>
</body>
