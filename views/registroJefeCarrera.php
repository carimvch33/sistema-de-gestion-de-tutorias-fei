...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL; ?>/assets/css/registroJefeCarrera.css">
...
<body>
    ...
    <div class="header-container">
        ...
        <div class="header-left">
            <button class="buttonsHead" onclick="location.href='<?= BASE_URL; ?>/administrarJefesCarrera.php'"><i class="fas fa-arrow-left"></i> Regresar</button>
    ...
    <div class="container mt-5">
        ...
        <form action="<?= BASE_URL; ?>/crearJefeCarrera.php" method="post" enctype="multipart/form-data" id="form">
