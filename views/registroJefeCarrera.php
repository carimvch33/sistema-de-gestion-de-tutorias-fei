...
<head>
    <meta charset="UTF-8">
    <title>Formulario de Registro de Jefe de Carrera</title>
    <link rel="stylesheet" href="assets/css/registroJefeCarrera.css">
...
<body>
    ...
    <div class="header-container">
        ...
        <div class="header-left">
            <button class="buttonsHead" onclick="location.href='./administrarJefesCarrera.php'"><i class="fas fa-arrow-left"></i> Regresar</button>
    ...
    <div class="container mt-5">
        ...
        <form action="/crearJefeCarrera.php" method="post" enctype="multipart/form-data" id="form">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre de jefe de carrera máximo 70 caracteres" maxlength="70">
            </div>
    ...
    <script src="assets/js/registroJefeCarrera.js"></script>
</body>
