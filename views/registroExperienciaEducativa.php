...
<head>
    ...
    <link rel="stylesheet" href="assets/css/registroExperienciaEducativa.css">
...
<body>
    ...
    <div class="header-container">
        ...
        <div class="header-left">
            <button class="buttonsHead" onclick="location.href='./administrarExperienciasEducativas.php'"><i
    ...
    <div class="container mt-5">
        ...
        <form action="/crearExperiencia.php" method="post" enctype="multipart/form-data" id="form">
                ...
                <select class="form-control" id="programa" name="programa">
                    ...
                    <?php foreach ($programas as $programa) { ?>
                        <option value="<?php echo $programa['idCarrera']; ?>">
                            <?php echo htmlspecialchars($programa['carrera']); ?>
                        </option>
                    <?php } ?>
                </select>
            </div>
    ...
    <script src="assets/js/registroExperienciaEducativa.js"></script>
</body>
