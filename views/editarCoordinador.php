...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="<?= BASE_URL; ?>/actualizarCoordinador.php" method="POST" enctype="multipart/form-data" id="form">
    ...
    <script src="<?= BASE_URL; ?>/assets/js/editarCoordinador.js"></script>
</body>
