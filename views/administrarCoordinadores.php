...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL; ?>/assets/css/administrarCoordinadores.css">
...
<body>
    ...
    <div class="new-button-container">
        <button class="buttonNew" onclick="location.href = '<?= BASE_URL; ?>/registroCoordinador.php' "><i class="fas fa-plus"></i>
            Nuevo</button>
    </div>
    ...
    <script src="<?= BASE_URL; ?>/assets/js/administrarCoordinadores.js"></script>
</body>
