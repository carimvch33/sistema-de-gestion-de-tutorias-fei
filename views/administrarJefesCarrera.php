...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL; ?>/assets/css/administrarJefesCarrera.css">
...
<body>
    ...
    <div class="new-button-container">
        <button class="buttonNew" onclick="location.href = '<?= BASE_URL; ?>/registroJefeCarrera.php' "><i class="fas fa-plus"></i>
            Nuevo</button>
    </div>
