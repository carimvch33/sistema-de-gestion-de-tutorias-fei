...
<head>
    ...
    <link rel="stylesheet" href="assets/css/editarPeriodo.css">
...
<body>
    ...
    <div class="header-container">
        ...
        <div class="header-left">
            <button class="buttonsHead" onclick="location.href='./administrarPeriodosEscolares.php'"><i
    ...
    <div class="container mt-5">
        ...
        <form action="/actualizarPeriodo.php" method="POST" enctype="multipart/form-data" id="form">
