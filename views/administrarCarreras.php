...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL; ?>/assets/css/administrarCarreras.css">
...
<body>
    ...
    <div class="new-button-container">
        <button class="buttonNew" onclick="location.href = '<?= BASE_URL; ?>/registroCarrera.php' "><i class="fas fa-plus"></i>
            Nuevo</button>
    </div>
    ...
    <script src="<?= BASE_URL; ?>/assets/js/administrarCarreras.js"></script>
</body>
