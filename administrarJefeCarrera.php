...
<body>
    ...
    <div class="new-button-container">
        <button class="buttonNew" onclick="location.href = './registroJefeCarrera.php' "><i class="fas fa-plus"></i> Nuevo</button>
    </div>
...
<script>
    $(document).ready(function() {
        $('#jefesCarreraTable').DataTable({
            "language": {
                "url": "https://cdn.datatables.net/plug-ins/1.13.5/i18n/es-MX.json",
                "emptyTable": "<div class='empty-table-message'>No hay jefes de carrera disponibles</div>",
        ...
        $('#searchCoordinador').on('input', function() {
