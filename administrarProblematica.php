<?php
    ...
    $stmt = $conn->prepare("SELECT  p.idProblematica, 
                                    p.descripcion, 
                                    tp.nombre  
                            FROM problematica p 
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<tr>
                                    ...
                                    <td class='action-buttons autoTable'>
                                        ...
                                        <button class='delete' data-id-problematica='{$idProblematica}' data-csrf-token='{$_SESSION['csrf_token']}'><i class='fas fa-trash-alt'></i></button>
                                    </td>
                                </tr>";
                        }
                    }
