...
<body>
    <div class="header-container">
        <div class="header-left">
            ...
            <button class="buttonsHead" onclick="location.href='./menuCoordinador.php'"><i class="fas fa-home"></i> Inicio</button>
    ...
    <div class="button-container">
        <button class="button-style" style="background-image: url('./img/importar-icon.png');" onclick="location.href='./consultaTutorias.php'"> Consulta de Tutorías</button>
