...
<html lang="es">
    ...
    <body>
        ...
        <div class="container mt-5">
            <form action="crearProblematica.php" method="post" enctype="multipart/form-data" id="form">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="tipoProblematica" name="tipoProblematica" required>
                        <option value="" disabled selected>-----Selecciona el el tipo de problemática asignada a la problemática-----</option>
                        <?php while($tipoProblematica = $arrayTipoProblematica->fetch_assoc()) { ?>
                            <option value="<?php echo $tipoProblematica['idTipoProblematica']; ?>"><?php echo $tipoProblematica['nombre']; ?></option>
                        <?php } ?>
                    </select>
                </div>
