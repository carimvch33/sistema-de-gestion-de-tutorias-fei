<?php
    ...
    $stmt = $conn->prepare("SELECT  c.idCarrera, 
                                    c.nombre AS carrera 
                            FROM carrera c");
...
<body>
    ...
    <div class="new-button-container">
        <button class="buttonNew" onclick="location.href = './registroCarrera.php' "><i class="fas fa-plus"></i> Nuevo</button>
    </div>
    ...
    $(document).ready(function() {
        $('#carrerasTable').DataTable({
            "language": {
                ...
                "emptyTable": "<div class='empty-table-message'>No hay carreras disponibles</div>",
        ...
        function confirmDelete(idCarrera, csrfToken) {
            Swal.fire({
        ...
        $(document).on('click', '.delete', function() {
            var idCarrera = $(this).data('id-carrera');
            var csrfToken = $(this).data('csrf-token');
            confirmDelete(idCarrera, csrfToken);
        });
        
        $(document).on('click', '.edit', function() {
            var idCarrera = $(this).data('id-carrera');
            editCarrera(idCarrera);
        });
    });
</script>