...
<body>
    ...
    <div class="new-button-container">
        <button class="buttonNew" onclick="location.href = './registroTutoria.php' "><i class="fas fa-plus"></i> Nuevo</button>
    </div>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<tr>
                                    ...
                                    <td class='action-buttons autoTable'>
                                        <button class='edit' data-id-tutoria='<?php echo $idTutoria; ?>'><i class='fas fa-edit'></i></button>
                                        <button class='delete' data-id-tutoria='<?php echo $idTutoria; ?>' data-csrf-token='<?php echo $_SESSION['csrf_token']; ?>'><i class='fas fa-trash-alt'></i></button>
                                    </td>
                        <?php
                                    echo "</tr>";
                        }
